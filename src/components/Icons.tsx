/** Shared action icons (Heroicons outline style). Use with className e.g. "w-4 h-4" or "w-5 h-5". */
...
export function IconPaperAirplane({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={`${iconClass} ${className}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
...
export function IconEnvelope({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={`${iconClass} ${className}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
...
export function IconCog({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={`${iconClass} ${className}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
