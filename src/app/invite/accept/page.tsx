    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-teal-50 text-slate-900 flex flex-col items-center justify-center px-4">
        <div className="w-full max-w-md rounded-2xl border border-cyan-200/80 bg-white/95 shadow-xl shadow-cyan-500/10 p-6 text-center backdrop-blur-sm">
          ...
          <p className="text-slate-700 text-base">Redirecting you to log in…</p>
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-teal-50 text-slate-900 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <p className="text-slate-700 text-base text-center mb-6">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-cyan-500 hover:bg-cyan-600 text-white font-medium py-2.5 px-4 rounded-xl text-base transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-cyan-500/25"
          >
  ...
  return (
    <Suspense fallback={
      <main className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-teal-50 flex items-center justify-center">
        <p className="text-slate-700 text-base font-medium">Loading…</p>
      </main>
    }>
      <InviteAcceptForm />
    </Suspense>
