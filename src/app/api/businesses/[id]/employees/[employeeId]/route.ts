...
export async function PATCH(
  ...
  try {
    ...
    const linkData: { payCycle?: string | null; payDayOfWeek?: number | null; payDayOfMonth?: number | null } = {};
    const cycle = payCycle === "weekly" || payCycle === "monthly" ? payCycle : payCycle === "" || payCycle === null ? null : undefined;
    ...
    return NextResponse.json({
      ...
      payCycle: updatedLink?.payCycle ?? undefined,
      payDayOfWeek: updatedLink?.payDayOfWeek ?? undefined,
      payDayOfMonth: updatedLink?.payDayOfMonth ?? undefined,
    });
  } catch (error) {
    console.error(error);
    return NextResponse.json(
