...
import { IconLogin, IconUserPlus, IconHome } from "@/components/Icons";
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-teal-50 text-slate-800 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        <h1 className="text-4xl font-bold text-slate-900 text-center mb-6 uppercase tracking-wide">
          Log in
        </h1>
        {activated && (
          <p className="text-lg text-cyan-700 bg-cyan-50 border border-cyan-200 rounded-xl px-3 py-2 mb-4 text-center font-medium">
...
export default function LoginPage() {
  return (
    <Suspense
      fallback={
        <main className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-teal-50 text-slate-800 flex flex-col items-center justify-center px-4">
          <div className="w-full max-w-md text-center text-slate-600">Loading…</div>
        </main>
      }
    >
      <LoginForm />
