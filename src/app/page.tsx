...
import { IconLogin, IconUserPlus } from "@/components/Icons";
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-teal-50 text-slate-800 flex flex-col items-center justify-center px-4 py-12">
      <div className="max-w-lg w-full text-center">
        <h1 className="text-4xl font-bold text-slate-900 tracking-tight mb-2 uppercase tracking-wide">
          Payslip Portal
        </h1>
          ...
          <section className="rounded-2xl border border-cyan-200/80 bg-white/90 shadow-lg shadow-cyan-500/10 p-6 text-left backdrop-blur-sm">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-cyan-500 hover:bg-cyan-600 text-white font-medium text-lg py-2.5 px-5 transition-colors shadow-md shadow-cyan-500/25 uppercase tracking-wide"
              >
              ...
              <Link
                href="/signup"
                className="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-cyan-300 text-cyan-700 hover:bg-cyan-50 py-2.5 px-5 transition-colors font-medium text-lg uppercase tracking-wide"
              >
        ...
        <section className="mt-14 w-full max-w-2xl">
          <h2 className="text-2xl font-bold text-slate-900 mb-6 text-center uppercase tracking-wide">
          ...
          <ul className="space-y-4">
            {faqs.map((faq, i) => (
              ...
              >
                <h3 className="text-lg font-semibold text-slate-900 mb-2 uppercase tracking-wide">
                  {faq.q}
                </h3>
